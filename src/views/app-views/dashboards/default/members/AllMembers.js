...
const AllMembers = () => {
	...
	const tableColumns = [
		...
		},
		{
			...
			render: stock => (
                <>  
                <Button className='mr-2' onClick={addProduct} type="primary" size='small'>Actions</Button>
                <Button onClick={addProduct} type="primary" size='small'>Reports</Button>
                </>
                ),
			sorter: (a, b) => utils.antdTableSorter(a, b, 'stock')
		},
		...
		<Card>
			<Flex alignItems="center" justifyContent="space-between" mobileFlex={false}>
				...
				<div className='mr-md-3 mt-3'>
					<Button onClick={addProduct} type="primary" block>Search</Button>
				</div>
			</Flex>
    </Card>
    <Card>
